#!/bin/bash
# Quick LLM-only EM run for wiki biographies.
#
# Default usage:
...
#SBATCH --mem=40G
#SBATCH --time=4:00:00
#SBATCH --output=logs/em_wiki_llm_quick_%j.out
#SBATCH --error=logs/em_wiki_llm_quick_%j.err
...
POINTS_PER_CLUSTER="${POINTS_PER_CLUSTER:-10}"
N_ITERS="${N_ITERS:-1}"
