#!/bin/bash
#SBATCH --job-name=step5_label_kmeans
#SBATCH --account=nlp
...
#SBATCH --mem=40G
#SBATCH --time=14-0
#SBATCH --output=logs/step5_label_%j.out
#SBATCH --error=logs/step5_label_%j.err

set -euo pipefail

REPO_DIR="/nlp/scr/tdalmia/projects/neural-taxonomy"
INPUT_FILE="experiments/wiki_biographies_10000/models/all_extracted_discourse_with_clusters.csv"
OUTPUT_FILE="experiments/wiki_biographies_10000/models/cluster_labels.csv"
